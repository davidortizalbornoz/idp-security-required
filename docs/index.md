...
| 24 | CIBA Backchannel (OIDC Client-Initiated Backchannel Authentication) [![NO APLICABLE](https://img.shields.io/badge/NO%20APLICABLE-red?style=flat-square)](#punto-24-ciba-backchannel) | Recomendado / Obligatorio en *decoupled* SFA | ✅ Soportado |
| 25 | FAPI CIBA + PingMode [![NO APLICABLE](https://img.shields.io/badge/NO%20APLICABLE-red?style=flat-square)](#punto-25-fapi-ciba-pingmode) | Sí (FAPI-CIBA: `ping`/`poll`; `push` prohibido) | ✅ Parcial (`push` limitado) |
| 26 | ACR / AMR — niveles de autenticación [![EN CONSULTA DE APLICABILIDAD](https://img.shields.io/badge/EN%20CONSULTA%20DE%20APLICABILIDAD-yellow?style=flat-square)](#punto-26-acr-amr) | Sí (SCA) | ✅ Soportado |
| 27 | WebAuthn / FIDO2 para SCA [![NO APLICABLE](https://img.shields.io/badge/NO%20APLICABLE-red?style=flat-square)](#punto-27-webauthn-fido2) | Recomendado | ✅ Soportado |
| 28 | Session Management OIDC + `id_token_hint` para logout [![NO APLICABLE](https://img.shields.io/badge/NO%20APLICABLE-red?style=flat-square)](#punto-28-session-management) | Sí | ✅ Soportado |
| 29 | Front-channel / Back-channel logout (RP-Initiated Logout) [![NO APLICABLE](https://img.shields.io/badge/NO%20APLICABLE-red?style=flat-square)](#punto-29-front-back-channel-logout) | Sí (revocación de sesión) | ✅ Soportado |
...
| 33 | Resiliencia / HA del Authorization Server [![EN CONSULTA DE APLICABILIDAD](https://img.shields.io/badge/EN%20CONSULTA%20DE%20APLICABILIDAD-yellow?style=flat-square)](#punto-33-resiliencia-ha) | Sí (SLA) | ✅ Soportado (Infinispan + DB HA) |
| 34 | Time synchronization (NTP) [![EN CONSULTA DE APLICABILIDAD](https://img.shields.io/badge/EN%20CONSULTA%20DE%20APLICABILIDAD-yellow?style=flat-square)](#punto-34-time-synchronization) | Implícito | ⚠️ Depende del SO |
...
| 39 | Mapeo de `sub` estable y no-PII [![EN CONSULTA DE APLICABILIDAD](https://img.shields.io/badge/EN%20CONSULTA%20DE%20APLICABILIDAD-yellow?style=flat-square)](#punto-39-mapeo-sub) | Sí | ✅ Soportado |
...
# 24. CIBA Backchannel (OIDC Client-Initiated Backchannel Authentication) ![NO APLICABLE](https://img.shields.io/badge/NO%20APLICABLE-red?style=flat-square)
...
# 25. FAPI CIBA + PingMode ![NO APLICABLE](https://img.shields.io/badge/NO%20APLICABLE-red?style=flat-square)
...
# 26. ACR / AMR — niveles de autenticación ![EN CONSULTA DE APLICABILIDAD](https://img.shields.io/badge/EN%20CONSULTA%20DE%20APLICABILIDAD-yellow?style=flat-square)
...
# 27. WebAuthn / FIDO2 para SCA ![NO APLICABLE](https://img.shields.io/badge/NO%20APLICABLE-red?style=flat-square)
...
# 28. Session Management OIDC + `id_token_hint` para logout ![NO APLICABLE](https://img.shields.io/badge/NO%20APLICABLE-red?style=flat-square)
...
# 29. Front-channel / Back-channel logout (RP-Initiated Logout) ![NO APLICABLE](https://img.shields.io/badge/NO%20APLICABLE-red?style=flat-square)
...
# 33. Resiliencia / HA del Authorization Server ![EN CONSULTA DE APLICABILIDAD](https://img.shields.io/badge/EN%20CONSULTA%20DE%20APLICABILIDAD-yellow?style=flat-square)
...
# 34. Time synchronization (NTP) ![EN CONSULTA DE APLICABILIDAD](https://img.shields.io/badge/EN%20CONSULTA%20DE%20APLICABILIDAD-yellow?style=flat-square)
...
# 39. Mapeo de `sub` estable y no-PII ![EN CONSULTA DE APLICABILIDAD](https://img.shields.io/badge/EN%20CONSULTA%20DE%20APLICABILIDAD-yellow?style=flat-square)
